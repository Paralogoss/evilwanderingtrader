...
public class ModItemTypes {
    ...
    public static RegistryObject<ModSpawnEggItem> THIEF_WANDERING_TRADER_SPAWN_EGG = ITEMS.register("thief_wandering_trader_spawn_egg",
            () -> new ModSpawnEggItem(ModEntityTypes.THIEF_WANDERING_TRADER,
